...
Когда бот-юзер получает Администратора беседы (выдаётся через версию для ПК), он выдаёт роль `admin` Создателю беседы и роли `supermoderator` другим Администраторам беседы.
