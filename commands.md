...
- 🧑 `/онлайн` Список участников, которые сейчас онлайн
...
- 🔨 `/кикнеактив 🕒` Кикнуть участников, не писавших сообщения в последнее время
...
- 🧑 `/тут 🕒 <команда>` Удалить ответ через указанное время. Пример: `/тут 1м начальники`
- 🧑 `/тут <продолжение сообщения>` Модификатор команды, который заставляет бота ответить в беседе и не удалять ответ. Пример: `/тут начальники`
...
- 🔑 `/приветствие <текст/пересылки>` Задать сообщение, которое нужно посылать при добавлении в беседу
...
- 🧑 `/рейтинг 👤` Рейтинг пользователя в беседе. По умолчанию, ваш. Показывает число написанных слов и дату первого сообщения
