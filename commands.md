...
- 🔑 стмодер / `supermoderator` — все команды модераторов, плюс управление ролями, сокращениями, описаниями
...
- 🧑 `/настройки` Названия и текущие значения настроек беседы
...
- 👑 `/ботадмин <ссылка на бота-админа>` Выбрать бота-админа среди присутствующих в беседе.
Можно посылать команды и другому боту-админу, если упомянуть его в начале сообщения с командой
- 👑 `/ботпомощник <ссылка на бота-помощника>` Выбрать бота-помощника среди присутствующих в беседе
...
- 🧑🤖 `/профили <пользователь>` Показать ссылки на аккаунты CR указанного пользователя
...
- 🧑 `/каналы` Список каналов сервера беседы (если беседа состоит в сервере)
...
- 🧑 `/каналы` Показывает название сервера и всех бесед. Текущая беседа помечена `[here]`
