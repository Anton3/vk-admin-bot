...
- 🧑 `/напиши <текст>` Бот напишет, что захотите. В начале сообщения бот добавит значок ✍, в котором содержится ссылка на вас

## Приглашение и исключение из беседы

- 🔨 `/кик 👥` Кикнуть из беседы. Кик бессрочный. Кикнутого можно пригласить обратно
- 🔨 `/киксобак` Кикнуть забаненных пользователей
...
Ещё можно удалить само сообщение с командой через заданный срок:
