...
- 🔨 `/привязать <игра> #тег-игрока <пользователь>` Привязать пользователю аккаунт CR или BS
- 🔨 `/отвязать <игра> #тег-игрока <пользователь>` Отвязать от пользователя аккаунт CR или BS
...
- 🧑🤖 `/кто <пользователь>` Показать роли и краткое описание аккаунтов пользователя
