...
- 👑 `/создатель <пользователи>` = `/дать admin`
- 👑 `/админ <пользователи>` = `/дать supermoderator`
- 🔑 `/модератор <пользователи>` = `/дать moderator`
- 🔨 `/участник <пользователи>` = `/дать normal`

* Если вы решите переименовать эти роли, учтите, что команды `/создатель` и т.д. не поменяются. Смотрите, не запутайтесь!
