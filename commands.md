...
- 🔑 `/антиссылки` Переключить удаление всех ссылок
- 🔑 `/антифото` Переключить удаление всех фото и видео
- 🔑 `/антифлуд` Если от одного участника идут 2 сообщения с кучей эмодзи или стикеров или дублей подряд, старое такое сообщение удаляется
- 🔑 `/антикофи` Переключить удаление шифровок от Coffi
...
- 🔑 `/антирейд` Бот будет кикать за очень большие сообщения, за сообщения с кучей эмодзи, за слишком частые сообщения (см. `/вминуту`), за подозрение на спам от новичков и за 5 нарушений подряд (см. `/антиграффити`, `/антиссылки`, `/антифото`)
