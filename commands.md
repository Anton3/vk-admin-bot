...
- 👑 `/создатель 👥` = `/дать admin`
- 👑 `/админ 👥` = `/дать supermoderator`
- 🔑 `/модератор 👥` = `/дать moderator`
- 🔨 `/участник 👥` = `/дать normal`
...
- 🔑 `/вминуту <число>` Указать ограничение на число сообщений в минуту для не-модеров
...
- 🔑 `/новоесокращение <название> <текст>` Добавить сокращение
- 🔑 `/удалисокращение <название>` Удалить сокращение
- 🔑 `/сокращение <название>` Показать содержимое сокращения
...
- 🧑 `/рейтинг 👤` Рейтинг пользователя в беседе. По умолчанию, ваш
