...
- 🔑 `/антирейд` Бот будет кикать за очень большие сообщения, за сообщения с кучей эмодзи, за слишком частые сообщения (см. /вминуту) или за подозрение на спам от новичков
