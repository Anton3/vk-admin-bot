...
- 🔑 `/антирейд` Бот будет кикать за 5 нарушений подряд (см. `/вминуту`, `/антиграффити`, `/антиссылки`, `/антифото`), а также за очень большие сообщения и за сообщения с кучей эмодзи
